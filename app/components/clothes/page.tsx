                ...
                {product.map((product) => (
                    ...
                    <div key={product._id} >
                      ...
                      <div className="border rounded-lg shadow-md p-4 hover:shadow-lg transition duration-200">
                        ...
                        {/* <button
                        className=" text-white py-2 px-4 rounded-lg shadow-md hover:shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out" style={{ backgroundColor: "#23A6F0"}}
